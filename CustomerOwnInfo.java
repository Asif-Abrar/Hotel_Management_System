...
public class CustomerOwnInfo extends JFrame implements ActionListener
{
	JLabel userLabel, eNameLabel, phoneLabel,addreLabel;
	JTextField userTF, phoneTF1, phoneTF2, eNameTF,addreTF;
	JButton  loadBtn,backBtn, logoutBtn;
	JPanel panel;
	
	String userId;
	
	public CustomerOwnInfo(String userId)
	{
		super("Customer OwnInfo");
		...
		addreLabel = new JLabel("Address : ");
		addreLabel.setBounds(250, 300, 120, 30);
		panel.add(addreLabel);
		
		addreTF = new JTextField();
		addreTF.setBounds(400, 300, 120, 30);
		panel.add(addreTF);
